        ...
        <div className="max-w-2xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 h-72 md:h-40 lg:h-16 relative pt-5">
          <Zoom>
            <div className="relative">
              <Image
                ...
                src="/assets/images/businessInsider-support.svg"
                layout="fill"
                objectFit="contain"
                alt="I"
              />
          ...
          <Zoom delay={100}>
            <div className="relative">
              <Image
                className="opacity-60 hover:opacity-100 transition-opacity duration-700"
                src="/assets/images/cityam-support.svg"
                layout="fill"
                objectFit="contain"
                alt="I"
              />
          ...
          <Zoom delay={200}>
            <div className="relative">
              <Image
                className="opacity-60 hover:opacity-100 transition-opacity duration-700"
                src="/assets/images/forbes-support.svg"
                layout="fill"
                objectFit="contain"
                alt="I"
              />
          ...
          <Zoom delay={300}>
            <div className="relative">
              <Image
                className="opacity-60 hover:opacity-100 transition-opacity duration-700"
                src="/assets/images/yahoo_finance-support.svg"
                layout="fill"
                objectFit="contain"
                alt="I"
              />
